        ...
        <form action="login.jsp" method="POST" class="form border2">
          ...
          <div class="formtxt3 formtxt0 border none">
            <%
                ...
                out.print(inpemail+"<br/>"+inppassword);
...
create table info(id int(4) primary key auto_increment,title varchar(50),content text,datetime varchar(20));
